...
class Controller(object):
    ...
    def __init__(self):
        ...
        self.beta = 1.0
        self.neg_samples_per_triple = 4 #author = 2
    ...
    def set_controller_config(self):
        ...
        if self.KB_name == 'Wordnet_':
            ...
            self.KB_path = '/content/resource_5/Conceptnet_edgelist_pra0.tsv'
            ...
            self.lr2 = 0.001
            self.lamda = 0.001
            self.KB_path = '/Users/taanhtuan/Desktop/workproject/CILK/resource_5/Nell_edgelist_pra0.tsv'
    ...
    def get_PLE_sets(self, perf_buff):
        if self.PLE_enabled:
            ...
            rel_set = sorted(list(candidate_set.items()), key=itemgetter(1))
            ...
            ent_set = sorted(list(candidate_set.items()), key=itemgetter(1))
    ...
    def search_source_cpt_and_query_rel(self, source, rel, KB):
        return source in KB.entity_vocab, rel in KB.rel_vocab

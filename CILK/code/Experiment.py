...
def update_hits_k(q_rel, hits_k_res_rel, hits_k_res):
    if q_rel in hits_k_res_rel:
        for top_k, val in list(hits_k_res.items()):
...
if __name__ == "__main__" :
    ...
    # path = r'/Users/taanhtuan/Desktop/workproject/CILK/KB_dumps/'+ result_folder+'/'+ KB_name +'eval_buff.pickle'
    # known_info_map_path = r'./KB_dumps/' + result_folder + '/' + KB_name + 'known_info_map.pickle'

    evaluation_buffer_path = r"/Users/taanhtuan/Desktop/workproject/CILK/KB_dumps/Nell_140_250D/rth_btr_c1_ef3/Nell_eval_buff.pickle"
    known_info_map_path = r"/Users/taanhtuan/Desktop/workproject/CILK/KB_dumps/Nell_140_250D/rth_btr_c1_ef3/Nell_known_info_map.pickle"
    print(evaluation_buffer_path)
    print(known_info_map_path)

    with open(evaluation_buffer_path, "rb") as input_file:
         evaluation_buffer = pickle2.load(input_file)
    with open(known_info_map_path, "rb") as input_file:
